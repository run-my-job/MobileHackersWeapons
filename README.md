...
| Tags  | [`Unpinning`](/categorize/tags/Unpinning.md) [`NFC`](/categorize/tags/NFC.md) [`Target`](/categorize/tags/Target.md) [`SCRIPTS`](/categorize/tags/SCRIPTS.md) [`Jailbreak`](/categorize/tags/Jailbreak.md) [`Hijack`](/categorize/tags/Hijack.md) [`Discovery`](/categorize/tags/Discovery.md) [`Bluetooth`](/categorize/tags/Bluetooth.md) [`Inject`](/categorize/tags/Inject.md) [`Monitor`](/categorize/tags/Monitor.md)                         |
| Langs | [`Python`](/categorize/langs/Python.md) [`C++`](/categorize/langs/C++.md) [`TypeScript`](/categorize/langs/TypeScript.md) [`JavaScript`](/categorize/langs/JavaScript.md) [`Unknown`](/categorize/langs/Unknown.md) [`Ruby`](/categorize/langs/Ruby.md) [`Shell`](/categorize/langs/Shell.md) [`Go`](/categorize/langs/Go.md) [`Java`](/categorize/langs/Java.md) [`Meson`](/categorize/langs/Meson.md) [`Objective-C`](/categorize/langs/Objective-C.md) [`Kotlin`](/categorize/langs/Kotlin.md) [`C`](/categorize/langs/C.md) [`Objective-C++`](/categorize/langs/Objective-C++.md)                        |
